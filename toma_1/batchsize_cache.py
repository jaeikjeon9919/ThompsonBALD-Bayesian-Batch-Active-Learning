...
import toma_1.cpu_memory
from toma_1 import stacktrace as tst, torch_cuda_memory as tcm
import weakref
...
class StacktraceMemoryBatchsizeCache(BatchsizeCache):
    ...
    def get_batchsize(self, initial_batchsize: int):
        ...
        if self.TRACK_RAM:
            cpu_available_memory = int(toma_1.cpu_memory.get_available_cpu_memory() // self.MEMORY_GRANULARITY)
        else:
